...
export default function TransactionDetails() {
  ...
  const { getTransactionDetails, transactionDetails, error, isLoading } =
    useTransaction();
            ...
            <div className="grid grid-cols-2">
              <div>
                ...
                <div>
                  ...
                  <dd>{`${transactionDetails?.customer?.membership}`}</dd>
                </div>
              </div>
              <div>
                ...
                <div>
                  ...
                  <dd>{`${transactionDetails?.partner?.bussinessName}`}</dd>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2">
              <div>
                ...
                <div>
                  ...
                  <dd>{`${transactionDetails?.promotionId?.title} `}</dd>
                </div>
                <div>
                  <dt className="font-medium">Category:</dt>
                  <dd>{`${transactionDetails?.promotionId?.categoryName}`}</dd>
                </div>
                <div>
                  <dt className="font-medium">Discount:</dt>
                  <dd>{`${transactionDetails?.promotionId?.discount} %`}</dd>
                </div>
                <div>
                  <dt className="font-medium">Duration:</dt>
                  <dd>{`${transactionDetails?.promotionId?.duration}`}</dd>
                </div>
              </div>
              <div>
